...
import com.picampers.utils.Mailapi1;
...
//  tablereclamation.refresh();
 ...
 @FXML
    ...
    public TableView<Reclamation> getTable(){
           TableView<Reclamation> t = this.tvReclamations; 
           return this.tvReclamations;
    }
    @FXML
...
m.setFrom(new InternetAddress("ahmed.balti@esprit.tn"));
...
@FXML
  ...
  String filename = "C:\\Users\\Ramez\\Documents\\NetBeansProjects\\pidev-backup\\ariiiiij pidevvv\\picampers\\Relclamation.xlsx";
